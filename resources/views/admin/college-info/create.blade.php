    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="{{ route('college-info.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select id="college_package" name="college_package"
                                        ...
                                        <option value="1" @selected(old('college_package') == 1)>Package 1</option>
                                        <option value="2" @selected(old('college_package') == 2)>Package 2</option>
                                        <option value="3" @selected(old('college_package') == 3)>Package 3</option>
                                    </select>
