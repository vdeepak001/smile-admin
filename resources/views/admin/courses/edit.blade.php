                ...
                <form action="{{ route('courses.update', $course) }}" method="POST" class="space-y-6"
                    ...
                    <div>
                        ...
                        @if ($course->course_pic)
                            <div class="mb-2">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Current picture</p>
                            </div>
                        @endif
                        ...
                        @error('course_pic')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">Accepted formats: JPEG, PNG, JPG, GIF (Max: 2MB). Leave
                            blank to keep current picture.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="test_questions" name="test_questions"
                            value="{{ old('test_questions', $course->test_questions) }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="percent_require" name="percent_require"
                            value="{{ old('percent_require', $course->percent_require) }}"
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" id="active_status" name="active_status" value="1"
                            @checked(old('active_status', $course->active_status))
