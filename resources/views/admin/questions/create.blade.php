                ...
                <form action="{{ route('questions.store') }}" method="POST" class="space-y-6"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <div>
                            ...
                            <select id="topic_id" name="topic_id"
                                ...
                                @foreach ($topics as $topic)
                                    <option value="{{ $topic->topic_id }}" @selected(old('topic_id') == $topic->topic_id)>
                                        {{ $topic->topic_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select id="level" name="level"
                                ...
                                <option value="1" @selected(old('level') == '1')>Level 1 (Easy)</option>
                                <option value="2" @selected(old('level') == '2')>Level 2</option>
                                <option value="3" @selected(old('level') == '3')>Level 3 (Medium)</option>
                                <option value="4" @selected(old('level') == '4')>Level 4</option>
                                <option value="5" @selected(old('level') == '5')>Level 5 (Hard)</option>
                            </select>
                            @error('level')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <select id="right_answer" name="right_answer"
                            ...
                            <option value="1" @selected(old('right_answer') == '1')>Choice 1</option>
                            <option value="2" @selected(old('right_answer') == '2')>Choice 2</option>
                            <option value="3" @selected(old('right_answer') == '3')>Choice 3</option>
                            <option value="4" @selected(old('right_answer') == '4')>Choice 4</option>
                        </select>
                        @error('right_answer')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea id="reasoning" name="reasoning" rows="3"
                            ...
                            placeholder="Explain why this is the correct answer">{{ old('reasoning') }}</textarea>
                        @error('reasoning')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
