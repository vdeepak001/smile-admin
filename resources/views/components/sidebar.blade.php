            ...
            @if ($isStudent)
                <div class="mb-4">
                    ...
                    <a href="{{ route('student.my-reports') }}"
                        class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors duration-200
                        {{ in_array(Route::currentRouteName(), ['student.my-reports', 'student.course-report', 'student.test-report']) ? 'bg-green-600 text-white' : 'text-slate-300 hover:bg-slate-700' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                    ...
                    <a href="{{ route('student.my-resume') }}"
                        class="flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors duration-200
                        {{ Route::currentRouteName() === 'student.my-resume' ? 'bg-orange-600 text-white' : 'text-slate-300 hover:bg-slate-700' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
