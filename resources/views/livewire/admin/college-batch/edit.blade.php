        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Batch</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-purple-600 to-blue-600">
                    <h3 class="text-lg font-semibold text-white">Edit Batch</h3>
                    <p class="text-sm text-purple-100">Update batch information for {{ $college->college_name }}</p>
                </div>

                <form wire:submit.prevent="update" class="p-6 space-y-6">
                    <!-- First Row: Year, Batch ID, Start Date, End Date (25% each) -->
                    ...
                    <!-- Second Row: Courses (50%) and Batch Type + Actions (50%) -->
                    <div class="grid grid-cols-2 gap-6">
                        <!-- Courses (Multi-select) - Left Column (50%) -->
                        <div>
