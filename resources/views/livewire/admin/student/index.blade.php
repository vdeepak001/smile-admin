                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                {{ $student->user->phone_number ?? 'N/A' }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $student->degree->name ?? 'N/A' }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $student->specialization ?? 'N/A' }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
        ...
        @if ($selectedStudent)
            <div class="p-6">
                ...
                <div class="space-y-6">
                    <!-- User Information -->
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-3">User Information
                        </h3>
                        <div class="bg-gray-50 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-900">
                                    {{ $selectedStudent->user->phone_number ?? 'N/A' }}</p>
                            </div>
                            <div class="md:col-span-2">
                                <p class="text-xs text-gray-500 mb-1">College</p>
                                <p class="font-medium text-gray-900">
                                    {{ $selectedStudent->user->college->college_name ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Student Information -->
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-3">Student Details
                        </h3>
                        <div class="bg-gray-50 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-900">
                                    {{ $selectedStudent->date_of_birth ? $selectedStudent->date_of_birth->format('M d, Y') : 'N/A' }}
                                </p>
                            </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900 font-mono">
                                                {{ $assignedCourse->course->course_code ?? 'N/A' }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @php
                                                $statusColors = [
                                            ...
                                            @endphp
                                            <span
                                                class="inline-flex px-2 text-xs font-semibold leading-5 rounded-full {{ $statusColors[$assignedCourse->completion_status] ?? 'bg-gray-100 text-gray-800' }}">
