        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @if($showPreTest)
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg relative {{ $preTestEnabled ? '' : 'opacity-50 grayscale' }}">
                    ...
                    <div class="p-6">
                         @if($preTestMark)
                            <p class="text-green-600 text-sm font-medium">Pre-test completed. Topic tests are now unlocked.</p>
                         @else
            ...
            <!-- Final Test Section -->
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg relative {{ $finalTestEnabled ? '' : 'opacity-50 grayscale' }}">
                    ...
                    <div class="p-6">
                        @if($finalTestMark)
                            <p class="text-purple-600 text-sm font-medium">Congratulations! You have completed the course.</p>
                        @else
                            <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm">
